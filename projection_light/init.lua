local function light_it_up(itemstack, placer, pointed_thing)
	...
	if minetest.is_protected(pos, placer:get_player_name())~=true then
...
minetest.register_alias("projection_light:light","air")
...
minetest.register_node("projection_light:light", {
	...
	on_place = function(itemstack, placer, pointed_thing)
		return light_it_up(itemstack, placer, pointed_thing)
	end,
