...
local function add_teleport_privs(pos,placer,istack,pt)
	...
	if pn then
		...
		minetest.chat_send_player(pn, "******************************************")
		minetest.chat_send_player(pn, "***** !!!!!  You Can Now Teleport !!!! ****")
		minetest.chat_send_player(pn, "*******************************************")
		minetest.chat_send_player(pn, " ")
...
minetest.register_node("oddnodes:teleport", {
    description="Gain Teleport",
    drawtype = "nodebox",
    node_box = {
        type = "wallmounted",
    ...
    wield_image = "teleport.png",
    sunlight_propagates = true,
    tiles = { "teleport.png" },
	light_source = 14,
    inventory_image = "teleport.png",
	after_place_node = add_teleport_privs,
	groups = {cracky=3, choppy=3},
	sounds = default.node_sound_stone_defaults(),
})

minetest.register_craft({
	output = 'oddnodes:teleport',
	recipe = {
		{"default:mese", "", "oddnodes:noclip"},
		{"", "oddnodes:fast", ""},
		{"oddnodes:fly", "", "default:mese"},
	}
})