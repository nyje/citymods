...
mobs:register_spawn("mobs_badplayer:badplayer2", {"default:dirt_with_grass","default:stone", "default:stonebrick","default:cobble","default:dirt_with_dry_grass","es:strange_grass","es:aiden_grass"}, 4, -1, 45000, 1, 3000)
mobs:register_spawn("mobs_badplayer:badplayer3", {"default:dirt_with_grass","default:stone", "default:stonebrick","default:cobble","default:dirt_with_dry_grass","es:strange_grass","es:aiden_grass"}, 4, -1, 45000, 1, 3000)
]]

local spawnon = {"default:dirt_with_grass","cityscape:road","cityscape:sidewalk","cityscape:roof","default:cobble","default:dirt_with_rainforest_litter"}

local spawnlist = { "mobs_badplayer:badplayer4","mobs_badplayer:badplayer6","mobs_badplayer:badplayer7",
                    "mobs_badplayer:badplayer8","mobs_badplayer:badplayer9","mobs_badplayer:badplayer10",
                    "mobs_badplayer:badplayer11","mobs_badplayer:badplayer12","mobs_badplayer:badplayer16",
                    "mobs_badplayer:badplayer18","mobs_badplayer:badplayer22","mobs_badplayer:badplayer23",
                    "mobs_badplayer:badplayer24","mobs_badplayer:badplayer25","mobs_badplayer:badplayer26",
                    "mobs_badplayer:badplayer27","mobs_badplayer:badplayer28","mobs_badplayer:badplayer29",
                    "mobs_badplayer:badplayer30","mobs_badplayer:badplayer31","mobs_badplayer:badplayer35" }

for _,c in pairs(spawnlist) do
    mobs:spawn_specific(c,spawnon, {"air"},0, 8, 30, 10000, 1, 15, 31000)
end
...
--mobs:spawn_specific("mobs_badplayer:just_test_griefer",{ "default:cobble"}, {"air"},0, 12, 35, 13000, 1, 0, 31000)
mobs:spawn_specific("mobs_badplayer:just_test_griefer",{ "default:cobble"}, {"air"},0, 8, 30, 15000, 1, 15, 31000)
mobs:spawn_specific("mobs_badplayer:Mr_Black",spawnon, {"air"},0, 8, 30, 30000, 1, 15, 31000)
mobs:spawn_specific("mobs_badplayer:Jasmine",spawnon, {"air"},0, 8, 30, 60000, 1, 15, 31000)
mobs:spawn_specific("mobs_badplayer:Infinium_Monster",spawnon, {"air"},0, 8, 30, 90000, 1, 15, 31000)
