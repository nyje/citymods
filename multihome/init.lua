...
local max    = minetest.setting_get("multihome.max") or 10
local compat = minetest.setting_get("multihome.compatibility") or "override"
local import = minetest.setting_get("multihome.import") or "true"
