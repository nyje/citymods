...
if minetest.get_modpath("3d_armor") then
    armor:register_armor("lavastuff:helmet", {
        ...
        groups = {armor_head=1, armor_heal=13, armor_use=100, armor_fire=15},
    ...
    armor:register_armor("lavastuff:chestplate", {
        ...
        groups = {armor_torso=1, armor_heal=13, armor_use=100, armor_fire=15},
    ...
    armor:register_armor("lavastuff:leggings", {
        ...
        groups = {armor_legs=1, armor_heal=13, armor_use=100, armor_fire=15},
        armor_groups = {fleshy=22},
        damage_groups = {cracky=2, snappy=1, level=3},
        wear = 0,
    })
    ...
    armor:register_armor("lavastuff:boots", {
        ...
        groups = {armor_feet=1, armor_heal=13, armor_use=100, armor_fire=15, physics_jump=0.5, physics_speed = 1.4},
    ...
    armor:register_armor("lavastuff:shield", {
        ...
        groups = {armor_shield=1, armor_heal=13, armor_use=100, armor_fire=10},
        armor_groups = {fleshy=22},
        damage_groups = {cracky=2, snappy=1, level=3},
        wear = 0,
    })
