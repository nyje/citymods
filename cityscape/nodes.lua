...
minetest.register_node("cityscape:concrete2", {
	description = "Concrete2",
	tiles = {"default_stone.png^[colorize:#964B00:40"},
	groups = {cracky = 3, level=1, stone = 1},
	sounds = default.node_sound_stone_defaults(),
	is_ground_content = false,
})
minetest.register_node("cityscape:concrete3", {
	description = "Concrete3",
	tiles = {"default_stone.png^[colorize:#FF0000:20"},
	groups = {cracky = 3, level=1, stone = 1},
	sounds = default.node_sound_stone_defaults(),
	is_ground_content = false,
})
minetest.register_node("cityscape:concrete4", {
	description = "Concrete4",
	tiles = {"default_stone.png^[colorize:#4682B4:10"},
	groups = {cracky = 3, level=1, stone = 1},
	sounds = default.node_sound_stone_defaults(),
	is_ground_content = false,
})
minetest.register_node("cityscape:concrete5", {
	description = "Concrete5",
	tiles = {"default_stone.png^[colorize:#000000:40"},
	groups = {cracky = 3, level=1, stone = 1},
	sounds = default.node_sound_stone_defaults(),
	is_ground_content = false,
})
...
local goodies = {
	...
	{ items = {"farming:donut 12",}, rarity = 10, },
	{ items = {"farming:bread 12",}, rarity = 10, },
	{ items = {"farming:corn_cob 12",}, rarity = 10, },
	{ items = {"farming:melon_8 12",}, rarity = 10, },
	{ items = {"mobs:cheeseblock 12",}, rarity = 10, },
	{ items = {"farming:pumpkin 12",}, rarity = 10, },
	{ items = {"farming:donut_apple 12",}, rarity = 10, },
	{ items = {"farming:donut_chocolate 12",}, rarity = 10, },
	{ items = {"cityscape:canned_food 12",}, rarity = 3, },
	{ items = {"cityscape:molotov_cocktail 5",}, rarity = 10, },
	{ items = {"default:steel_ingot 3",}, rarity = 10, },
	{ items = {"default:copper_ingot 3",}, rarity = 10, },
	{ items = {"default:book 10",}, rarity = 10, },
	{ items = {"default:paper 10",}, rarity = 10, },
	{ items = {"default:meselamp",}, rarity = 10, },
	{ items = {"default:snowblock 10",}, rarity = 10, },
}
...
if minetest.get_modpath("wool") then
	...
	goodies[#goodies+1] = { items = {"wool:white 10",}, rarity = 10, }
end
if minetest.get_modpath("love_mod") then
	goodies[#goodies+1] = { items = {"love_mod:sapling 1",}, rarity = 10, }
end

if minetest.get_modpath("dye") then
	goodies[#goodies+1] = { items = {"dye:blue 10",}, rarity = 10, }
	goodies[#goodies+1] = { items = {"dye:red 10",}, rarity = 10, }
	goodies[#goodies+1] = { items = {"dye:green 10",}, rarity = 10, }
	goodies[#goodies+1] = { items = {"dye:yellow 10",}, rarity = 10, }
	goodies[#goodies+1] = { items = {"dye:cyan 10",}, rarity = 10, }
	goodies[#goodies+1] = { items = {"dye:magenta 10",}, rarity = 10, }
	goodies[#goodies+1] = { items = {"dye:orange 10",}, rarity = 10, }
	goodies[#goodies+1] = { items = {"dye:violet 10",}, rarity = 10, }
	goodies[#goodies+1] = { items = {"dye:pink 10",}, rarity = 10, }
	goodies[#goodies+1] = { items = {"dye:white 10",}, rarity = 10, }
end
